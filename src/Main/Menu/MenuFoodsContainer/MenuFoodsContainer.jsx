...
export default function MenuFoodsContainer({ children }) {
  ...
  //     image: "../src/assets/images/best seller/Cheese Beef Hamburger.png",
  //     badge: "../src/assets/images/Badge Discount.png",
  //     price: 5.49,
  //   },
  //   {
  //     id: 2,
  //     title: "Combo funny",
  //     desc: "fried chicken balls, french fries",
  //     image: "../src/assets/images/best seller/Combo funny.png",
  //     badge: "../src/assets/images/Badge Discount.png",
  //     price: 10.39,
  //   },
  //   {
  ...
  //     image: "../src/assets/images/best seller/‌Chicken with Spicy Sauce.png",
  //     badge: "../src/assets/images/Badge Discount.png",
  //     price: 7.29,
  //   },
  //   {
  ...
  //     image: "../src/assets/images/best seller/Salad mixed vinegar.png",
  //     badge: "",
  //     price: 3.39,
  //   },
  //   {
  ...
  //     desc: "fried chicken",
  //     image: "../src/assets/images/best seller/Chicken burger.png",
  //     badge: "",
  //     price: 5.89,
  //   },
  // ];
  return (
    <div className="menu_foods_container">
      ...
      <MenuFoodContainer
        ...
        image="../src/assets/images/best seller/Lipton.png"
        badge=""
        price={0.89}
      />
      <MenuFoodContainer
        title={allFoods[0].title}
        desc={allFoods[0].desc}
        image={allFoods[0].image}
        badge={allFoods[0].badge}
