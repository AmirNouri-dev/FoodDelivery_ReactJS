...
<div className="menu_foods_container">
              <div className="menu_food_container">
                <div className="discount_badge">
                  <img src="../src/assets/images/Badge Discount.png" alt="" />
                </div>
                <div className="menu_food_img">
                  <img
                    src="../src/assets/images/best seller/Cheese Beef Hamburger.png"
                    alt="burger"
                  />
                ...
                <div className="menu_food_price">
                  <div className="menu_food_price_cost">5.39$</div>
              ...
              <div className="menu_food_container">
                ...
                <div className="menu_food_img">
                  <img
                    src="../src/assets/images/best seller/Combo funny.png"
                    alt="burger"
                  />
                  <div className="menu_food_img_bg"></div>
                </div>
                ...
                <div className="menu_food_price">
                  <div className="menu_food_price_cost">10.39$</div>
                  <button className="menu_food_price_order">
                    <svg
                      width="24"
                      height="24"
              ...
              <div className="menu_food_container">
                ...
                <div className="menu_food_img">
                  <img
                    src="../src/assets/images/best seller/‌Chicken with Spicy Sauce.png"
                    alt="burger"
                  />
                  <div className="menu_food_img_bg"></div>
                </div>
                ...
                <div className="menu_food_price">
                  <div className="menu_food_price_cost">7.29$</div>
                  <button className="menu_food_price_order">
                    <svg
                      width="24"
                      height="24"
              ...
              <div className="menu_food_container">
                <div className="menu_food_img">
                  <img
                    src="../src/assets/images/best seller/Salad mixed vinegar.png"
                    alt="burger"
                  />
                  <div className="menu_food_img_bg"></div>
                </div>
                ...
                <div className="menu_food_price">
                  <div className="menu_food_price_cost">3.39$</div>
                  <button className="menu_food_price_order">
                    <svg
                      width="24"
                      height="24"
              ...
              <div className="menu_food_container">
                <div className="menu_food_img">
                  <img
                    src="../src/assets/images/best seller/Chicken burger.png"
                    alt="burger"
                  />
                  <div className="menu_food_img_bg"></div>
                </div>
              ...
              <div className="menu_food_container">
                <div className="menu_food_img">
                  <img src="../src/assets/images/best seller/Lipton.png" alt="burger" />
                  <div className="menu_food_img_bg"></div>
                </div>
                <div className="menu_food_infos">
                  <h5>Lipton</h5>
                  <p>Tea with Ice,Lime and Mint</p>
                  <div className="menu_food_infos_score">
                    <svg
                      width="20"
                      height="19"
                ...
                <div className="menu_food_price">
                  <div className="menu_food_price_cost">0.89$</div>
                  <button className="menu_food_price_order">
                    <svg
                      width="24"
                      height="24"
